...
*/
    ...
    BSP_Initialize();     //tph had to add- todo: update harmony configuration
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C3, INT_PRIORITY_LEVEL4);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_I2C3, INT_SUBPRIORITY_LEVEL3);

    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C1, INT_PRIORITY_LEVEL4);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_I2C1, INT_SUBPRIORITY_LEVEL3);

    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C5, INT_PRIORITY_LEVEL4);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_I2C5, INT_SUBPRIORITY_LEVEL3);
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_T1, INT_PRIORITY_LEVEL5);
